...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="flex items-center justify-between pb-20 mt-4">
      <div className="invisible md:visible">
        <Avatar className="transition-transform duration-300 hover:scale-200">
          <AvatarImage src="/media/Untitled.jpg" />
      ...
      <div className="md:hidden fixed top-1 left-1 z-50">
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuItem onSelect={handleScroll("skills")}>
              Egenskaper
            </DropdownMenuItem>
